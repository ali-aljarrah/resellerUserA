...
<body id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" class="app-default">
    ...
    <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
        ...
        <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
            <!--begin::Header-->
            <?php $parentPage = 'Send SMS'; $childPage = 'Single SMS'; include 'include/header.php'?>
            <!--end::Header-->
            <!--begin::Wrapper-->
                                            ...
                                            <div class="card-body">
                                                <form action="#" id="frmSendSingleSms" name="frmSendSingleSms" novalidate="novalidate">
                                                    ...
                                                    <div class="mb-8">
                                                        ...
                                                        <select class="form-select form-custom-select" onchange="javascript:setMessageLength();" id="cmbMessageType" name="cmbMessageType" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Please Select Message Type">
                                                    ...
                                                    <div class="mb-8">
                                                        ...
                                                        <input type="text" class="form-control form-custom-input" onkeypress="return goodchars(event,'0123456789,+');" name="txtNumber" id="txtNumber" placeholder="Use number with country code" data-bs-toggle="tooltip" data-bs-placement="top" title="Please Enter Mobile Number,Maximum 30 numbers can be added seperated by comma.."/>
                                                    </div>
                                                    <div class="mb-8">
                                                        ...
                                                        <div class="fs-12 text-gradients-blue">
                                                            <input type="text" name="txtcount" value="0 : 1 SMS Parts" readonly="readonly" class="fs-12 text-gradients-blue text-start border-0">
                                                    ...
                                                    <div class="d-flex justify-content-start align-items-start">
                                                        ...
                                                        <button type="button" class="btn btn-outline-dark btn-bordered py-4 px-8 rounded-2 ms-8" id="btnSaveTemplate" name="btnSaveTemplate">
