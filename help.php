...
<body id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" class="app-default">
    ...
    <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
        ...
        <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
            <!--begin::Header-->
            <?php $parentPage = 'Help'; $childPage = 'Help'; include 'include/header.php'?>
            <!--end::Header-->
            <!--begin::Wrapper-->
                            ...
                            <div id="kt_app_content_container" class="app-container container-fluid">
                                <!--begin::Row-->
										...
										<div class="col-md-4 mb-md-0 mb-5 mt-5">
											<div class="custom-border-left h-100 mt-10 mt-md-0">
												<div class="p-8">
													<div>
														<div class="mb-6">
															<p class="fs-16 fw-500 dark-color mb-1">
															Support Ticket
															</p>
                                    ...
                                    <div class="row g-5 g-xl-10 mb-xl-10 mt-0">
                                          ...
                                          <div class="page-title d-flex flex-column justify-content-center gap-1">
                                                <!--begin::Title-->
                                                <div class="mb-1 fs-16 dark-color fw-600">
                                                     Video Tutorials
                                                </div>
                                    ...
                                    <div class="row g-5 g-xl-12 mb-xl-12 mt-0 px-5">
                                        <div class="col-4">
                                            <img src="assets/img/home/Frame 298.png" class="p-3" height="350" width="400" loading="lazy" alt="reseller">
                                        </div>
                                        <div class="col-4">
                                            <img src="assets/img/home/Frame 298.png" class="p-3" height="350" width="400" loading="lazy" alt="reseller">
                                        </div>
                                    ...
                                    <div class="row g-5 g-xl-10 mb-xl-10 mt-0 px-5">
                                        <div class="col-4">
                                            <img src="assets/img/home/Frame 298.png" class="p-3" height="350" width="400" loading="lazy" alt="reseller">
                                        </div>
                                        <div class="col-4">
