                                ...
                                <div class="row g-5 g-xl-10">
                                    ...
                                    <div class="col-xl-8 mb-xl-10">
                                        ...
                                        <div class="card card-flush shadow-xs">
                                            ...
                                            <!--begin::Body-->
                                            <div class="card-body">
                                                <form action="manage-temp" method="POST" novalidate="novalidate" id="temp_form" name="temp_form">
                                                    ...
                                                    <div class="mb-10">
                                                        ...
                                                        <input value="" type="text" name="temp_name" id="temp_name" class="form-control form-custom-input" placeholder="Template name" data-bs-toggle="tooltip" data-bs-placement="top" title="Please enter template name here">
                                                    </div>
                                                    <div class="mb-10">
                                                        <label for="temp_msg" class="form-label fs-14 color-black-1 required">Template message</label>
                                                        <textarea maxlength="766" type="text" cols="5" rows="5" name="temp_msg" id="temp_msg" class="form-control form-custom-textarea" data-bs-toggle="tooltip" data-bs-placement="top" title="Please enter template message body here" placeholder="Write message here..."></textarea>
                                                    </div>
                                                    <div class="text-start">
                                                        <input type="hidden" name="savetemp" id="savetemp" value="savetemp">
                                                        <button type="submit" class="btn btn-grad-1 py-4 px-9 rounded-3" id="savetempbtn" name="savetempbtn">
                                    ...
                                    <div class="col-xl-4">
                                        ...
                                        <div class="card card-flush shadow-xs">
                                            ...
                                            <div class="card-header d-block pt-7">
                                                <!--begin::Title-->
                                                <h3 class="card-title card-label fs-20 fw-bold color-black-1">
                                                Templates List <span class="fs-12 ms-2 color-light-blue fw-500 bg-light-blue rounded-2 px-2 py-1">8 available</span>
                                                </h3>
