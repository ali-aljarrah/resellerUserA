...
<body id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" class="app-default">
    ...
    <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
        ...
        <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
            <!--begin::Header-->
            <?php $parentPage = 'Billing'; $childPage = 'Standard Quality'; include 'include/header.php'?>
            <!--end::Header-->
            <!--begin::Wrapper-->
                                                    ...
                                                    <div class="row mt-10">
                                                        <div class="col-lg-6 mb-5 mx-auto">
                                                            <div class="plan-card">
                                                                <div class="row">
                                                                    <div class="col-md-6 mb-5 mb-md-0">
                                                                        <div class="fs-32 dark-color text-center text-md-start fw-600">
                                                                            $10
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row mt-5">
                                                                    <div class="col-md-6 mb-5 mb-md-0">
                                                                        <button type="submit" class="btn btn-dark py-2 px-4 rounded-3 w-100">
                                                                            <span class="me-2">
